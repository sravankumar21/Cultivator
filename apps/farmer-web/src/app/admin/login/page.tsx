      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/admin" className="inline-flex items-center gap-2.5">
            <div className="w-10 h-10 rounded-xl bg-[var(--color-text-primary)] flex items-center justify-center shadow-md">
        ...
        <div className="bg-[var(--color-surface-elevated)] rounded-3xl border border-[var(--color-border-light)] p-8 shadow-sm">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-xl font-bold text-[var(--color-text-primary)]">Admin Login</h1>
          </div>
          <p className="text-sm text-[var(--color-text-muted)] mb-6">Sign in to manage your enterprise network</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading || !email || !password}
              className="w-full h-12 bg-[var(--color-text-primary)] text-white text-sm font-bold rounded-xl hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
          ...
          <div className="mt-6 p-4 bg-[var(--color-surface-muted)] rounded-xl">
            <p className="text-xs font-semibold text-[var(--color-text-secondary)] mb-1">Demo: admin@cultivator.in / admin123</p>
          </div>
        </div>

        <div className="flex items-center justify-center gap-4 mt-6 text-xs text-[var(--color-text-muted)]">
          <Link href="/dealer/login" className="hover:text-[var(--color-text-primary)]">Dealer Login</Link>
          <span>&middot;</span>
